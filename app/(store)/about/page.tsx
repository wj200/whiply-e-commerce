...
export default function AboutPage() {
  return (
    <>
      <PageHeader title="About WHIPLY" blurb="A supplier, not a marketplace." />
      <Prose>
        <p>
        ...
        <p>
          ...
          industrial-grade stand mixer.
        </p>
        <h2>How we sell</h2>
        <p>
          No account required. Add what you need, pay, and we deliver. For trade quantities, use
          the bulk order enquiry and we will come back to you directly rather than send an
          automated quote.
        </p>
